...
from .views import HomePageView, AboutPageView, AccountInformationView, UpgradeToPremiumView
...
urlpatterns = [
    ...
    path('accounts/upgrade/', UpgradeToPremiumView.as_view(), name='upgrade_to_premium'),   # new
]
